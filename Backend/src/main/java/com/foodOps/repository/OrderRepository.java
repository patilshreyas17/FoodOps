...
public interface OrderRepository extends JpaRepository<Order,Long> {
	...
	@Query("SELECT DISTINCT o.customer FROM Order o WHERE o.restaurant.id = :restaurantId")
	List<User> findDistinctCustomersByRestaurantId(@Param("restaurantId") Long restaurantId);
}
