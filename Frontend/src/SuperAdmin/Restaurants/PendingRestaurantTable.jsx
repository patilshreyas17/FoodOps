...
import { getPendingRestaurants, approveRestaurant, rejectRestaurant } from "../../State/SuperAdmin/superAdmin.action";
    ...
    <Box width={"100%"}>
      <Card className="mt-1">
        <CardHeader
          ...
          subheader="Restaurants waiting for approval"
          sx={{
            pt: 2,
            alignItems: "center",
        ...
        />
        <TableContainer>
          <Table aria-label="pending restaurants table">
            <TableHead>
              <TableRow>
            ...
            <TableBody>
              ...
              {(!superAdmin.pendingRestaurants || superAdmin.pendingRestaurants.length === 0) && (
                <TableRow>
